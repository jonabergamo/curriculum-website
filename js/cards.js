...
const videos = [
  {
    ...
    subtitle:
      "Website ainda em desenvolvimento, consiste em um curriculo criado utilizando HTML, CSS E JAVASCRIPT. Estou estudando torna-lo 100% responsivo para qualquer dispositivo.",
  ...
  },
  {
    ...
    subtitle:
      "Um site onde é possivel acessar uma calculadora que faz operações matematicas simples. Foi feita utilizando HTML, CSS E JAVASCRIPT",
  ...
  },
  {
    ...
    subtitle:
      "Este website foi o primeiro que criei, ele consiste em um curriculo básico feito em HTML e CSS. Também possui um pouco de javascript onde adiciona um scroll bar colorido.",
    url: "",
...
videos.map((video) => {
  ...
  cardClone.querySelector(".info > p.text--low").innerHTML = video.subtitle;
